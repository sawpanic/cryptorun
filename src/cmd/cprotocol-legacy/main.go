...
import (
    ...
    domainPairs "cryptorun/domain/pairs"
    "cryptorun/application/universe"
    "cryptorun/infrastructure/apis/kraken"
    httpiface "cryptorun/interfaces/http"
)
...
func usage() {
    fmt.Println("Usage: cryptorun <scan|backtest|monitor|health> [flags]")
