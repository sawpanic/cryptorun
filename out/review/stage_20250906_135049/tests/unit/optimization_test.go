	...
	return []optimization.LedgerEntry{
		{
			...
			Composite: 75.0,
			GatesPass: true,
			Realized:  struct{ H24 float64 `json:"24h"`; H48 float64 `json:"48h"` }{H24: 2.5, H48: 3.8},
			Pass:      struct{ H24 bool `json:"24h"`; H48 bool `json:"48h"` }{H24: true, H48: true},
		},
		{
			...
			Composite: 68.0,
			GatesPass: true,
			Realized:  struct{ H24 float64 `json:"24h"`; H48 float64 `json:"48h"` }{H24: -1.2, H48: 0.5},
			Pass:      struct{ H24 bool `json:"24h"`; H48 bool `json:"48h"` }{H24: false, H48: true},
		},
	}, nil
}
