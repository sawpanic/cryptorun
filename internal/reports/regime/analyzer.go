...
func (ra *RegimeAnalyzer) getRegimeWeights(regime string) FactorWeights {
	switch regime {
	case "trending_bull":
		return FactorWeights{Momentum: 50.0, Technical: 20.0, Volume: 15.0, Quality: 10.0, Catalyst: 5.0}
	case "choppy":
		return FactorWeights{Momentum: 35.0, Technical: 30.0, Volume: 15.0, Quality: 15.0, Catalyst: 5.0}
	case "high_vol":
		return FactorWeights{Momentum: 30.0, Technical: 25.0, Volume: 20.0, Quality: 20.0, Catalyst: 5.0}
	default:
		return FactorWeights{Momentum: 35.0, Technical: 30.0, Volume: 15.0, Quality: 15.0, Catalyst: 5.0}
	}
}
